...
import { GraduationCap, Users, Clock, ArrowRight, Plus } from 'lucide-react'
                ...
                <div className="flex items-center gap-4 mt-3 text-sm text-muted-foreground">
                  ...
                  {cls.nextLessonTime && (
                    <span className="flex items-center gap-1">
                      ...
                      {formatDateTime(cls.nextLessonTime)}
                    </span>
                  )}
                </div>
              </CardContent>
              ...
              {mockClasses.map((cls) => (
                <TableRow key={cls.id}>
                  ...
                  <TableCell className="text-muted-foreground">
                    {cls.nextLessonTime ? formatDateTime(cls.nextLessonTime) : '-'}
                  </TableCell>
